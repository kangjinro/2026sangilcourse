...
const TabMySelect = (() => {
  ...
  function showSubjectPopup(name) {
    const s = appData.subjectsInfo.find(x => x.name === name);
  ...
  function renderChecklist() {
    ...
    `;
    return `
      <div class="checklist-section-title">이수학점 요건</div>
      ${cl.credits.map(row).join('')}
      <div class="checklist-section-title">교과 위계</div>
    ...
    const html = `
      ...
      <style>
        ...
        *{box-sizing:border-box;}
        body{font-family:'Malgun Gothic','Pretendard',sans-serif;color:#222;padding:8px 18px;}
        h1{font-size:19px;text-align:center;margin:0 0 4px;}
        .meta{text-align:center;color:#555;font-size:13px;margin-bottom:16px;}
        h2{font-size:14.5px;border-left:4px solid #E08E32;padding-left:8px;margin:16px 0 6px;}
        .sem-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:6px;}
        .sem-col-title{font-size:12.5px;font-weight:700;color:#E08E32;margin-bottom:3px;}
        ...
        .bottom-grid > div + div{margin-top:4px;}
        @media print{ body{padding:4px 14px;} }
      </style></head>
      <body>
        <h1>상일고등학교 수강과목 선택 점검표 (2026입학생)</h1>
        <div class="meta">학번: ${ScrapUI.escapeHtml(info.studentId) || '____'} &nbsp;&nbsp;|&nbsp;&nbsp; 이름: ${ScrapUI.escapeHtml(info.name) || '____'} &nbsp;&nbsp;|&nbsp;&nbsp; 작성일: ${dateStr}</div>
        ...
        <div class="bottom-grid">
          <div>
            ...
            <table class="result-table">
              ...
              <tbody>
                <tr class="section-row"><td colspan="3">이수학점 요건</td></tr>
                ...
                <tr class="section-row"><td colspan="3">교과 위계</td></tr>
