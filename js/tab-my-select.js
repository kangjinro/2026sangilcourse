  ...
  function render() {
    ...
    root().innerHTML = `
      ...
      <div class="student-info-row">
        ...
        <button class="btn-reset btn-reset-all" id="ms-reset-all-btn" type="button">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/></svg>
          개인정보 초기화
        </button>
      </div>
    ...
    document.getElementById('ms-reset-all-btn').addEventListener('click', () => {
      if (confirm('학번·이름·희망 학과, 선택한 과목, 스크랩까지 모두 지울까요?\n이 작업은 되돌릴 수 없습니다.')) {
        Store.resetPersonalInfo();
        render();
      }
    });
